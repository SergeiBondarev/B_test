# Shop: отображение страницы товара (97)
import time
...
HTML_5_book  = driver.find_element_by_css_selector("[title='Mastering HTML5 Forms']")
HTML_5_book.click()
time.sleep(1)

# Добавьте тест, что заголовок книги назвается: "HTML5 Forms"
Logout = driver.find_element_by_css_selector("[itemprop='name']")
Logout_get_text = Logout.text
assert Logout_get_text == "HTML5 Forms"
